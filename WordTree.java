...
public class WordTree {
    ...
    /**
     * Creates an empty WordTree object which serves only as a container for an existing trie
     */

    public WordTree(AlphagramTrie trie) {
        this.trie = trie;
    }

    /**
     * Creates an empty WordTree object which serves only as a container for a newly created trie
     */
 ...
 /*   public void generateCSVList(String prefix, TreeNode node) {
    ...
    public void generateCSVList(String prefix, String tooltip, TreeNode node) {

        CSV = CSV.concat("{\"id\": \"" + prefix + "\", \"tooltip\": \"" + tooltip + "\"},");
        for(TreeNode child : node.getChildren()) {
            ...
            generateCSVList(prefix + "." + child.toString(), nextTooltip, child);
        }
    }
